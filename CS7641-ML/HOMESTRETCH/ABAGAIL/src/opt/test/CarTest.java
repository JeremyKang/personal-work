 ...
 * find optimal weights to a neural network that is classifying car acceptability as either 
 * bad (i.e., unacceptable/acceptable) or good (good/very good). 
 *
 * @author Jeremy Kang
 * @version 1.0
 */
public class CarTest {
    ...
    private static Instance[] trainInstances = initializeInstances("carTraining-features.txt", "carTraining-labels.txt");
    private static Instance[] testInstances = initializeInstances("carTest-features.txt", "carTest-labels.txt");

    private static int inputLayer = 6, hiddenLayer = 1, outputLayer = 1;
